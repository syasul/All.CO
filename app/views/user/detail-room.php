        ...
        <div class="col-sm-4">
            <div class="description-side">
                <div class="description-side-text">
                    <div class="text-header"><?= $data['room']['name_room'] ?></div>
                    <div class="text-price">Rp. <?= $data['room']['price'] ?>,- /Day</div>
                    <div class="text-description"><?= $data['room']['description'] ?></div>
                </div>
                <div class="booking-side">
                    <form>
                        <div class="mb-2">
                            <label for="exampleInputEmail1" class="form-label">Nama</label>
                            <input type="text" class="form-control shadow-none" id="exampleInputEmail1" aria-describedby="emailHelp" value="Name" disabled>

                        </div>
                        <div class="mb-2">
                            <label for="exampleInputEmail1" class="form-label">Ktp</label>
                            <input type="file" class="form-control shadow-none" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="ktp">
